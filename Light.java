...
public class Light {
  ...
  private Vec3 startDirection =  new Vec3(0.5f, -0.3f, -0.5f);
  private Mat4 model;
  ...
  public Light(GL3 gl) {
    ...
    material.setSpecular(brightness, brightness, brightness);
    position = new Vec3(-5f,5.0f,4.0f);
  ...
  public void setDirection(Vec3 newDirection) {
