...
public class Aliens extends JFrame implements ActionListener {
  ...
  public Aliens(String textForTitleBar) {
    ...
    JPanel p = new JPanel();
      ...
      b.addActionListener(this);
      p.add(b);
      b = new JButton("dimmer");
      b.addActionListener(this);
      p.add(b);
      b = new JButton("brighter");
      b.addActionListener(this);
      p.add(b);
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    else if (e.getActionCommand().equalsIgnoreCase("dimmer")) {
      glEventListener.dimLight();
    }
    else if (e.getActionCommand().equalsIgnoreCase("brighter")) {
      glEventListener.brightLight();
    }
